...
export const TEMPLATE_VARIABLES = [
  ...
  { key: 'entity.acreage', label: 'Acreage', category: 'Entity' },
  { key: 'entity.totalValue', label: 'Total Value', category: 'Entity' },
  { key: 'entity.annualRevenue', label: 'Annual Revenue', category: 'Entity' },
  { key: 'entity.status', label: 'Status', category: 'Entity' },
  { key: 'entity.memberCount', label: 'Member Count', category: 'Entity' },
...
export function buildVariableMap(resolved: ResolvedEntity): Record<string, string> {
  ...
  return {
    ...
    'entity.acreage': e.acreage || '',
    'entity.totalValue': e.totalValue != null ? String(e.totalValue) : '',
    'entity.annualRevenue': e.annualRevenue != null ? String(e.annualRevenue) : '',
