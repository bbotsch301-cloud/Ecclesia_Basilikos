...
export default function Terms() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pt-24 pb-16">
      <h1 className="font-cinzel text-4xl font-bold text-royal-navy mb-2">Platform Usage Guidelines</h1>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">1. Relationship to PMA Agreement</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">2. Trust Administration Platform</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">3. User Accounts</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">4. Acceptable Use</h2>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">5. Trust Corpus</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">6. Forum and Community Guidelines</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">7. Disclaimer</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">8. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">9. Changes to Guidelines</h2>
          <p>
        ...
        <section>
          <h2 className="font-cinzel text-2xl font-semibold text-royal-navy">10. Contact</h2>
          <p>
