...
import { FileText, Heart, BookOpen, Download, CheckSquare, Calculator, Search, Phone } from "lucide-react";
  ...
  return (
    <div className="pt-16">
      <HeroSection
        ...
        description="Practical tools and templates to help you walk in covenantal freedom"
