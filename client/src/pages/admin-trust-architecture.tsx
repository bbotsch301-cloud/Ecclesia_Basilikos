...
The assembly organizes the people; the stewardship organs hold the assets for their benefit. Membership is voluntary and requires signing the PMA agreement. The PMA is constitutionally protected under First Amendment free association (NAACP v. Alabama, 357 U.S. 449; Roberts v. U.S. Jaycees, 468 U.S. 609; Boy Scouts of America v. Dale, 530 U.S. 640).`,
      },
      {
        ...
        content: `Regional assemblies organized geographically within the Body — city-churches following the pattern of the seven churches of Revelation.
...
Each region coordinates local members, worship, resource sharing, pastoral care, and ministry launches within its geographic area. Regions appoint local elders per the qualifications of 1 Timothy 3:1-7 and Titus 1:5-9.`,
      },
      {
        ...
        content: `House-churches and oikos groups — the intimate gatherings within the Body where daily fellowship, shared meals, common labor, and worship take place.
...
Key principles:
    ...
    • Members who leave the community vacate housing but are not displaced without process`,
      },
      {
        ...
        content: `"Bring ye all the tithes into the storehouse, that there may be meat in mine house" (Malachi 3:10). The treasury organ of the Body — the central storehouse.
...
"Honour the LORD with thy substance, and with the firstfruits of all thine increase" (Proverbs 3:9-10). All financial flows are private member contributions, not commercial transactions. The treasury operates under lawful money principles with complete financial transparency — quarterly reports to all members.`,
      },
      {
...
The "enters" relationship is:
    ...
    • Transformational — the old man dies, the new creation enters (2 Corinthians 5:17)`,
      },
      {
        ...
        content: `FUNDS — The Treasury Trust allocates funds to other stewardship organs. Treasury → Land Trust (acquisition), Treasury → Housing Trust (construction/maintenance), Treasury → Enterprise Trust (seed capital), Treasury → Education Trust (curriculum development). "Storehouse distribution" — Acts 4:34-35.
...
TITHES — The storehouse principle. Members tithe to Treasury. Regions, households, and crafts contribute their portion. "Bring ye all the tithes into the storehouse" (Malachi 3:10). "Upon the first day of the week let every one of you lay by him in store" (1 Corinthians 16:2). "Honour the LORD with thy substance, and with the firstfruits of all thine increase" (Proverbs 3:9).`,
      },
      {
        ...
        content: `SHEPHERDS — Pastoral care flowing through the hierarchy. Body → Assembly (pastoral oversight, 1 Peter 5:2). Assembly → Regions (shepherding, 1 Peter 5:1-2). Regions → Households ("He shall feed his flock like a shepherd" — Isaiah 40:11). The shepherding chain ensures every member receives pastoral care through their household, region, and assembly leadership.

TEACHES — Discipleship and knowledge transfer. Education Trust → Assembly (equipping the ecclesia, Ephesians 4:12). Education Trust → Crafts (training craft members, 2 Timothy 2:2). Assembly → Regions (doctrinal teaching, Matthew 28:20). Crafts → Regions (skills training, Exodus 35:10). The teaching chain ensures knowledge flows from the education organ through every level of the Body.

SERVES — Diaconal service following the example of Christ. Assembly → Members ("the Son of man came not to be ministered unto, but to minister" — Matthew 20:28). Crafts → Households ("By love serve one another" — Galatians 5:13). Regions → Members ("As we have therefore opportunity, let us do good unto all men" — Galatians 6:10).`,
      },
      {
...
The result is that a creditor seeking to reach trust assets must identify which specific organ holds the asset, pierce that specific trust's protections, overcome spendthrift provisions, and navigate the PMA's constitutional protections — a series of barriers that makes successful attack extremely difficult.`,
      },
      {
    ...
    subsections: [
      {
        ...
        content: `The covenant trust is irrevocable and perpetual — it has no expiration date.
...
These cross-layer relationships prevent the hierarchy from becoming rigid or bureaucratic. They ensure that the structure serves the Body's mission rather than constraining it.`,
    ...
    A SELF-GOVERNING COMMUNITY — Governance operates through defined authority chains, separation of powers, and the Matthew 18 protocol. No external courts, no state-chartered corporate boards, no regulatory compliance beyond constitutional protections.
