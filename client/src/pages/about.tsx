        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div>
              ...
              <div className="bg-parchment p-6 rounded-lg">
                ...
                <cite className="text-royal-gold font-semibold">Hebrews 8:6</cite>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="lg:order-1">
              <h2 className="font-cinzel text-3xl font-bold text-royal-navy mb-6">Contrast with Babylon's System</h2>
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Babylon operates through contracts, legal fictions, and the creation of artificial persons to bind mankind in debt slavery. Ecclesia Basilikos transcends these earthly systems, operating under the perfect law of liberty found in Christ.
              </p>
          ...
          <div className="bg-royal-navy p-12 rounded-2xl">
            <h3 className="font-cinzel-decorative text-3xl font-bold text-white mb-8 text-center">Scriptural Foundation</h3>
            <p className="text-white text-center mb-8 text-lg">
              Ecclesia Basilikos is established upon the sure foundation of God's Word, as revealed in the King James Version of the Holy Bible.
            </p>
            
            <div className="space-y-8">
              {/* The Promise of the New Covenant */}
              <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                <h4 className="font-cinzel text-xl font-bold text-royal-gold mb-4">The Promise of the New Covenant</h4>
                ...
                <cite className="text-royal-gold font-semibold">Jeremiah 31:31-33</cite>
              </div>

              {/* Spiritual Transformation */}
              <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                <h4 className="font-cinzel text-xl font-bold text-royal-gold mb-4">Spiritual Transformation</h4>
                <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                  "A new heart also will I give you, and a new spirit will I put within you: and I will take away the stony heart out of your flesh, and I will give you an heart of flesh. And I will put my spirit within you, and cause you to walk in my statutes, and ye shall keep my judgments, and do them."
                </blockquote>
                <cite className="text-royal-gold font-semibold">Ezekiel 36:26-27</cite>
              </div>

              <div className="grid md:grid-cols-2 gap-6">
                {/* Christ's Blood Covenant */}
                <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                  <h4 className="font-cinzel text-lg font-bold text-royal-gold mb-4">Christ's Blood Covenant</h4>
                  <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                    "Likewise also the cup after supper, saying, This cup is the new testament in my blood, which is shed for you."
                  </blockquote>
                  <cite className="text-royal-gold font-semibold">Luke 22:20</cite>
                </div>

                {/* Ministers of the New Testament */}
                <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                  <h4 className="font-cinzel text-lg font-bold text-royal-gold mb-4">Ministers of the New Testament</h4>
                  <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                    "Who also hath made us able ministers of the new testament; not of the letter, but of the spirit: for the letter killeth, but the spirit giveth life."
                  </blockquote>
                  <cite className="text-royal-gold font-semibold">2 Corinthians 3:6</cite>
                </div>

                {/* Jesus as Surety */}
                <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                  <h4 className="font-cinzel text-lg font-bold text-royal-gold mb-4">Jesus as Surety</h4>
                  <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                    "By so much was Jesus made a surety of a better testament."
                  </blockquote>
                  <cite className="text-royal-gold font-semibold">Hebrews 7:22</cite>
                </div>

                {/* Better Promises */}
                <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                  <h4 className="font-cinzel text-lg font-bold text-royal-gold mb-4">Better Promises</h4>
                  <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                  ...
                  <cite className="text-royal-gold font-semibold">Hebrews 8:6-10</cite>
                </div>
              </div>

              {/* The Mediator and Eternal Inheritance */}
              <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                <h4 className="font-cinzel text-xl font-bold text-royal-gold mb-4">The Mediator and Eternal Inheritance</h4>
                <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                  "And for this cause he is the mediator of the new testament, that by means of death, for the redemption of the transgressions that were under the first testament, they which are called might receive the promise of eternal inheritance."
                </blockquote>
                <cite className="text-royal-gold font-semibold">Hebrews 9:15</cite>
              </div>

              {/* The Covenant Written in Hearts */}
              <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                <h4 className="font-cinzel text-xl font-bold text-royal-gold mb-4">The Covenant Written in Hearts</h4>
                <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                  "This is the covenant that I will make with them after those days, saith the Lord, I will put my laws into their hearts, and in their minds will I write them; And their sins and iniquities will I remember no more."
                </blockquote>
                <cite className="text-royal-gold font-semibold">Hebrews 10:16-17</cite>
              </div>

              {/* The Eternal Kingdom */}
              <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                <h4 className="font-cinzel text-xl font-bold text-royal-gold mb-4">The Eternal Kingdom</h4>
                <blockquote className="font-georgia text-white mb-3 leading-relaxed">
                  "And in the days of these kings shall the God of heaven set up a kingdom, which shall never be destroyed: and the kingdom shall not be left to other people, but it shall break in pieces and consume all these kingdoms, and it shall stand for ever."
                </blockquote>
                <cite className="text-royal-gold font-semibold">Daniel 2:44</cite>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A basic introduction to trust roles and how Ecclesia Basilikos operates under divine law
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-parchment-dark">
                <div className="text-center mb-4">
                  ...
                  <h3 className="font-cinzel text-xl font-bold text-royal-navy">The Trustee</h3>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-royal-navy font-semibold">
                    <strong>In Ecclesia Basilikos:</strong> Believers who operate in Kingdom authority as royal priests.
                  </p>
                  <blockquote className="text-xs italic bg-parchment p-3 rounded">
            ...
            {/* How Ecclesia Basilikos Operates */}
            <div className="bg-gradient-to-r from-royal-navy to-royal-navy-light text-white p-8 rounded-xl">
              <h3 className="font-cinzel-decorative text-2xl font-bold mb-6 text-center">How Ecclesia Basilikos Operates</h3>
              
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-lg mb-4 text-royal-gold">Divine Authority Structure</h4>
                ...
                <div>
                  <h4 className="font-semibold text-lg mb-4 text-royal-gold">Trust Assets & Benefits</h4>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-start">
                      <span className="text-royal-gold mr-2">•</span>
              ...
              <div className="mt-6 p-4 bg-black/20 rounded-lg">
                <p className="text-center text-sm italic">
                  ...
                  <span className="block text-royal-gold font-semibold mt-2">- 2 Corinthians 5:21 (KJV)</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              {/* Royal Identity */}
              <div className="bg-white p-6 rounded-xl shadow-lg border border-parchment-dark">
                <h3 className="font-cinzel text-xl font-bold text-royal-navy mb-4">Royal Identity</h3>
                <p className="text-sm text-gray-600 mb-4">
                ...
                <div className="bg-parchment p-4 rounded-lg mb-4">
                  ...
                  <cite className="text-royal-gold font-semibold text-xs">Romans 8:17 (KJV)</cite>
                </div>
                <p className="text-sm text-gray-600">
              ...
              {/* Kingdom Freedom */}
              <div className="bg-white p-6 rounded-xl shadow-lg border border-parchment-dark">
                <h3 className="font-cinzel text-xl font-bold text-royal-navy mb-4">Kingdom Freedom</h3>
                <p className="text-sm text-gray-600 mb-4">
                ...
                <div className="bg-parchment p-4 rounded-lg mb-4">
                  ...
                  <cite className="text-royal-gold font-semibold text-xs">John 8:36 (KJV)</cite>
                </div>
                <p className="text-sm text-gray-600">
          ...
          <div className="mb-20">
            ...
            <div className="bg-gradient-to-br from-royal-navy via-royal-navy-light to-royal-navy text-white p-8 rounded-xl mb-8">
              ...
              <div className="mt-8 p-6 bg-black/20 rounded-lg">
                ...
                <cite className="text-royal-gold font-semibold text-center block">Ephesians 1:14 (KJV)</cite>
              </div>
            </div>

            {/* Your Divine Role */}
            <div className="bg-white p-8 rounded-xl shadow-lg border border-parchment-dark">
